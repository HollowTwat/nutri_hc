...
IMG1 = "AgACAgIAAxkBAAEKgpVoNK6PzKbe_jrFa_kg2MNujg-1ZQACm_YxG1FZoUnxIdcoIet3kgEAAwIAA3kAAzYE"
...
IMG4 = "AgACAgIAAxkBAAEKgppoNK6V-_VapSuw7V8O7X00WHPJ_AACnPYxG1FZoUm4NJoElcpWGAEAAwIAA3kAAzYE"
...
IMG7 = "AgACAgIAAxkBAAEKgp5oNK6e26e6-O0MmQSx002LsTL2owACnfYxG1FZoUmZMVLfyQLRJwEAAwIAA3kAAzYE"
IMG8 = "AgACAgIAAxkBAAEKgqJoNK6ih-Vsqx6m3wMU7Q9wW5RSPAACnvYxG1FZoUlK6ZgMLac_-wEAAwIAA3kAAzYE"
...
async def process_l6_step_2(callback_query, state):
    ...
    await callback_query.message.answer(text,reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="Хорошо", callback_data="next")]
        ])
    )
...
async def process_l6_step_11(callback_query, state):
    await callback_query.message.answer(
        "Время душевных разговоров. Если весь день было не до вопросов Нутри, то сейчас — самое время спросить всё, что ты хотел(а) узнать о питании, но боялся(лась) спросить!",
