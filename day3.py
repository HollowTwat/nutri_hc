...
async def process_l3_step_2(callback_query, state):
    ...
    text = f"<b>Урок 3</b> \n<b>С чем можно перепутать голод</b> \n\nИногда то, что мы принимаем за голод, бывает жаждой новых вкусов, новых эмоций и впечатлений. Всё это — разные типы голода! \n\nНа карточках вместе с нутрициологом рассказываем, какими бывают типы голода и как их различать. \n\nИсточники: \n🍏<a href=\'{link1}\'><i>Weight loss: Gain control of emotional eating</a> — Mayo Clinic</i> \n🍏<a href=\'{link2}\'><i>Emotion regulation difficulties interact with negative, not positive, emotional eating to strengthen relationships with disordered eating: An exploratory study</a> — Appetite</i> \n🍏<a href=\'{link3}\'><i>Emotional eating and obesity in adults: the role of depression, sleep and genes</a> — Proceedings of the Nutrition Society</i> \n🍏<a href=\'{link4}\'><i>The effect of taste and taste perception on satiation/satiety: a review</a> — ​​Food & Function</i>"
