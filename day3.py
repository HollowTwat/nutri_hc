...
async def process_l3_step_2(callback_query, state):
    ...
    text = f"<b>Урок 3</b> \n<b>С чем можно перепутать голод</b> \n\nИногда то, что мы принимаем за голод, бывает жаждой новых вкусов, новых эмоций и впечатлений. Всё это — разные типы голода! \n\nНа карточках вместе с нутрициологом рассказываем, какими бывают типы голода и как их различать. \n\nИсточники: \n🍏<a href=\'{link1}\'>Weight loss: Gain control of emotional eating — Mayo Clinic</a> \n🍏<a href=\'{link2}\'>Emotion regulation difficulties interact with negative, not positive, emotional eating to strengthen relationships with disordered eating: An exploratory study — Appetite</a> \n🍏<a href=\'{link3}\'>Emotional eating and obesity in adults: the role of depression, sleep and genes — Proceedings of the Nutrition Society</a> \n🍏<a href=\'{link4}\'>The effect of taste and taste perception on satiation/satiety: a review — ​​Food & Function</a>"
...
async def process_l3_step_4(callback_query, state):
    ...
    await callback_query.message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Хочу поесть", callback_data="1"),InlineKeyboardButton(text="Хочу поесть", callback_data="2"),InlineKeyboardButton(text="Хочу поесть", callback_data="3")]
        ])
    )
