...
async def process_step_2(callback_query, state):
    ...
    text1 = f'Звучит сложно, как и с любой новой привычкой, но я советую делать именно так!\nЕсть десятки исследований, которые <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC3268700/">доказывают, что регулярное ведение дневника помогает успешно терять вес и сохранять достигнутые результаты.'
