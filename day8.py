...
IMG4 = "AgACAgIAAxkBAAEKgrZoNK-ez6c1l211kM-TvSdP5r3kZQACovYxG1FZoUlTE8AwSWfHeQEAAwIAA3kAAzYE"
IMG5 = "AgACAgIAAxkBAAEKgrpoNK-iEXyWpHeL6hOmTLZAAbJq6gACo_YxG1FZoUkgkEyDSnEqMAEAAwIAA3kAAzYE"
...
IMG9 = "AgACAgIAAxkBAAEKgr5oNK-nQTe-G-n0nUHQN7r6zVNi7QACpPYxG1FZoUlfMi5lSVVOaQEAAwIAA3kAAzYE"
...
IMG12 = "AgACAgIAAxkBAAEKgsJoNK-sofU1msn7U4G-85ZibG2d1QACpfYxG1FZoUkAAdyNBovq81oBAAMCAAN5AAM2BA"
...
IMG15 = "AgACAgIAAxkBAAEKgsJoNK-sofU1msn7U4G-85ZibG2d1QACpfYxG1FZoUkAAdyNBovq81oBAAMCAAN5AAM2BA"
...
async def process_l8_step_3(callback_query, state):
    ...
    await callback_query.message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="Договорились", callback_data="next"), InlineKeyboardButton(text="Составить рецепт", callback_data="menu_nutri_reciepie")]
        ])
    )
    await callback_query.answer()
    try:
